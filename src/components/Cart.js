  ...
  return (
      ...
      <div className="flex flex-col w-1/5 self-end mt-5">
        ...
        <div className="mt-5 self-end mr-10">
          {productos.length > 0 ? (
					  <button className="flex rounded p-2 outline-pink-500 bg-pink-500 text-white hover:outline-3 hover:outline transitions-all delay-300">
						  <span className="font-bold">Comprar</span> <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
