      ...
      <div className="flex flex-col w-1/5 self-end mt-5">
        ...
        <div className="mt-5 self-end mr-10">
          {productos.length > 0 ? (
            <button
              onClick={handleBuy}
              className="flex rounded p-2 outline-pink-500 bg-pink-500 text-white hover:outline-3 hover:outline transitions-all delay-300"
            >
          ...
          <div>
            ...
            >
              <div className="flex flex-col grow text-center text-slate-500 p-2 ">
                ...
                <span className="text-sm">Orden: {orderId}</span>
